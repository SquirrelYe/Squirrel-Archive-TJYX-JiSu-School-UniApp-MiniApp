...
export default {
  ...
  methods: {
    ...
    // 进入详情页
    navToList(titem) {
      uni.navigateTo({ url: `/pages/fruit/fruit_list/fruit_list?item=${JSON.stringify(titem)}` });
    }
  }
};
</script>
