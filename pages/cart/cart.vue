          ...
          <view class="cart-item" :class="{ 'b-b': index !== cartList.length - 1 }">
            ...
            <view class="item-right">
              ...
              <block v-if="item.type == 2">
                ...
                <text class="price">¥{{ item.price }}</text>
                <uni-number-box class="step" :min="1" :value="item.number" :isMin="item.number === 1" :index="index" @eventChange="numberChange"></uni-number-box> </block
            ></view>
    ...
    deleteCartItem(index) {
      ...
      uni.showModal({
        ...
        success: e => {
          if (e.confirm) {
            // 删除购物车
            this.$apis.cart.delete(id).then(res => {
